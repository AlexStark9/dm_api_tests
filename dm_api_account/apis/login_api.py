...
class LoginApi:
    ...
    def post_v1_account_login(self, json: LoginCredentials, status_code: int = 200,
                              **kwargs) -> UserEnvelope | BadRequestError | GeneralError | Response:
        """
    ...
    def delete_v1_account_login(self, status_code: int = 200,
    ...
    def delete_v1_account_login_all(self, status_code: int = 200,
                                    **kwargs) -> GeneralError | Response:
        """
